#' Dataset for testing the ushape-cutpoint function
#'
#' A dataset containing data for testing the ushape-cutpoint function.
#'
#' @format ## "data2_ushape"
...
#' Dataset for testing the cutpoint estimating function: est_cutpoint
#'
