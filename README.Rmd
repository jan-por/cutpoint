...
-   Estimate one or two thresholds or cutpoints of a variable of
    interest in the multivariable context of survival data or
    time-to-event data

-   Visualise the threshold or cutpoint estimation process using contour
    plots, index plots, and spline plots

-   Estimate thresholds or cutpoints based on the assumption of a
    U-shaped or inverted U-shaped relationship between the predictor and
    the hazard ratio
...
![Figure 2. Covariate-adjusted spline plot with optimal degrees of
...
UR -
[https://CRAN.R-project.org/package=cutpoint](https://cran.r-project.org/web/packages/cutpoint/index.html "R Package Cutpoint"){.uri}
